...
function GravityStarsBackground({
  ...
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: This function is already very complex and breaking it down would make it harder to understand the overall logic.
  ...
  return (
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: Requited for mouse move and touch move events
    // biome-ignore lint/a11y/noStaticElementInteractions: Requited for mouse move and touch move events
    <div
